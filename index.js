...
console.log("CONNECTING GOKU_MD🐲...");
...
console.log('GOKU MD ⭐️ CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺𝙶𝙾𝙺𝚄 𝙼𝙳 ☄️𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴𝙳 𝚂𝚄𝙲𝙲𝙴𝚂𝚂 𝚃𝚈𝙿𝙴 .𝚖𝚎𝚗𝚞 𝚝𝚘 𝚜𝚑𝚘𝚠 𝚖𝚢 𝚕𝚒𝚜𝚝 𝚙𝚘𝚠𝚎𝚛 𝚖𝚊𝚜𝚝𝚎𝚛 🐲*

> *ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs GOKU MD*

*https://whatsapp.com/channel/0029Vb2VplFFCCoQsZKtVV24*


*╭⊱✫🐲 ᎶㄖҜㄩ 爪ᗪ 🐲✫⊱╮*
*│✫➠ - 🪢REPOSITORY NAME:* *GOKU_MD*
*│✫➠ - 📃DESCRIPTION:* *THE WORLD BEST WHATSAPP BOT♻️*
*│✫➠ - 🎓CREATOR:* *IGWE*
*│✫➠ - 🌐URL:* *https://github.com/DADDY_IGWE/GOKU_MD*

*ɪᴛꜱ ʏᴏᴜʀ ᴘʀᴇꜰɪx ᴛᴏ ᴜꜱᴇ ᴍʏ ᴘᴏᴡᴇʀ 🍃*\n\n*PREFIX: ${prefix}*

*╰──────────────●●►*`;
conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/ayr9h1.png` }, caption: up })
